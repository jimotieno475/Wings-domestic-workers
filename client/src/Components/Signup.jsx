      ...
      <div className="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl">
        <div className="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
          ...
          <img src={Logo} alt=""/>
            ...
            <p className="pr-3 text-sm opacity-75">Welcome You can book a worker of your choice her you will get the best services .</p>
          </div>
        </div>
        <div className="flex justify-center self-center z-10">
          <div className="p-12 bg-glass mx-auto rounded-3xl w-100">
            ...
            <div className="space-y-6">
              <div>
                <input className="w-full text-sm px-4 py-3 bg-gray-200 focus:bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="name" placeholder="Name"/>
              </div>
              <div>
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm ml-auto">
                  <button href="#" className="text-white hover:text-purple-500">Forgot your password?</button>
                </div>
              </div>
              <div>
              ...
              <p className="text-gray-900">You have an account? <button onClick={() => navigate('/login')} className="text-sm text-blue-700 hover:text-blue-300">Sign In</button></p>
              ...
              <p className="text-sm text-center text-gray-900">By signing in you agree to our <a href="#" className="text-purple-700 hover:text-purple-700">terms and conditions</a></p>
            </div>
          </div>
        </div>
      </div>
