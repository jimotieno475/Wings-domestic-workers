      ...
      <div className="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl">
        ...
        <div className="p-12 bg-glass mx-auto rounded-3xl w-100">
            ...
            <div className="space-y-6">
              ...
              <div>
                <button onClick={() => navigate('/employerdash')}type="submit" className="w-full flex justify-center bg-blue-900 hover:bg-blue-1000 text-gray-100 p-3 rounded-lg tracking-wide font-semibold cursor-pointer transition ease-in duration-500">
                  Sign in
                </button>
              </div>
              <p className="text-gray-900">Don't have an account? <button onClick={() => navigate('/singup')} className="text-sm text-blue-300 hover:text-blue-700">Sign Up</button></p>
              ...
              <p className="text-sm text-center text-rgb(0 0 0)">By signing in you agree to our <a href="#" className="text-purple-700 hover:text-purple-700">terms and conditions</a></p>
            </div>
          </div>
        </div>
      </div>
